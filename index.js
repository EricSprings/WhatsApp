...
/////////////////
const BotName = 'Springfields☄'; 
const instagram = 'https://instagram.com/eric071988'; 
const telegram = 
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@eric071988')
